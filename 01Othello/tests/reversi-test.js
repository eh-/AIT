...
describe('reversi', function(){
	...
	describe('repeat', function(){
		//Don't worry about incorrect range and don't worry about types
	...
	describe('generateBoard', function() {
		it('generates a board with specified number of rows and columns', function() {
			const board = rev.generateBoard(3, 3, "i");
      const expected = ["i", "i", "i", "i", "i", "i", "i", "i", "i",];
      expect(board).to.deep.equal(expected);
    });
		it('generate a board with default " "', function(){
