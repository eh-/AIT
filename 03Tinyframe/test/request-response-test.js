...
function mockSocket() {
  ...
  this.sinon.stub(socket, 'write');
  this.sinon.stub(socket, 'end');
}
...
describe('Request', function() {
  ...
  it('returns a string representing the request when toString is called', function() {
    var s = 'POST /foo/create HTTP/1.1\r\n';
    s += 'Host: localhost:8080\r\n';
  ...
  it('returns a string representing the request when toString is called with no body', function() {
    var s = 'POST /foo/create HTTP/1.1\r\n';
    s += 'Host: localhost:8080\r\n';
    s += 'Referer: localhost:8080/referer.html\r\n';
    s += '\r\n';
